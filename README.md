...
基于可穿戴生理信号的运动疲劳实时监测系统，通过LOPO交叉验证达到**80.00%**的Session级三分类准确率。
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 66.7% | 100% | 100% | 50% | 100% | 100% | 100% | 100% | 50% | 100% | 50% | 100% |

## 关键发现

1. **EEG为冗余信号**: 去除EEG后准确率不变（80%），特征减少14%，为手表部署奠定基础
2. **EDA是核心信号**: 去除EDA后准确率骤降至65%
3. **手表版本零损失**: 去除EEG和EMG后，手表版本与胸带版本准确率完全一致
4. **8/12参与者完全正确**: P01、P04、P09、P11 准确率较低，主要受数据质量和个体差异影响
